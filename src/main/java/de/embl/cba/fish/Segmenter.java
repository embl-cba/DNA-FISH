...
public class Segmenter
{
                                          ...
                                          SegmentationSettings segmentationSettings)
    {
        ...
        if( segmentationSettings.method.equals( SegmentationSettings.TRACKMATEDOG)
        ...
        else if ( segmentationSettings.method.equals( SegmentationSettings.IMAGESUITE3D))
        {
            ...
            SegmentationSettings segmentationSettings)
    {
        ...
        //
        segmentationResults.models = new Model[segmentationSettings.spotChannelIndicesOneBased.length];
